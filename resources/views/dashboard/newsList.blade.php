                                ...
                                <div class="box-content">
                                    <div id="tree1">
                                        <ul class="dynatree-container">
                                            <li class="">
                                                <span class="dynatree-node  dynatree-has-children dynatree-lastsib dynatree-exp-e dynatree-ico-e">
                                ...
                                <div class="box-content">
                                    <div class="form form-horizontal" style="margin-bottom: 0;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input class="form-control" id="inputText1" placeholder="" disabled="disabled" value="新闻分类" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
