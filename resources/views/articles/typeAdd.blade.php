            ...
            <div class="tpl-portlet-components" style="margin-top: -10px">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 新增博文分类
                    </div>
                </div>
                <div class="tpl-block ">
                    ...
                    <div class="am-g tpl-amazeui-form">
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" action="{{ url('/article/type/add') }}" method="post">
                                {!! csrf_field() !!}
                                ...
                                <div class="am-form-group">
                                    <label for="user-email" class="am-u-sm-3 am-form-label">封面图片地址 / url</label>
                                    <div class="am-u-sm-9">
                                        <input name="img" type="text" id="user-email" value="">
                                    </div>
                                </div>

                                <div class="am-form-group">
                                    <label for="user-phone" class="am-u-sm-3 am-form-label">简介 / introduction</label>
                                    <div class="am-u-sm-9">
                                        <input name="intro" type="tel" id="user-phone" placeholder="">
                                    </div>
                                </div>
                                <div class="am-form-group">
