    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li><a href="/send"><i class="fa fa-video-camera" aria-hidden="true"></i><span>社区</span></a></li>
        ...
        <div class="col-md-6">
            <div class="container-fluid">
                <div class="col-sm-4">
                    ...
                    <ul class="a-ul">
                        <li class="a-li"><a href="http://d.laravel-china.org/" class="a-link">laravel官网</a></li>
                        <li class="a-li"><a href="https://laravelchen.com/" class="a-link">LaravelChen个人网站</a></li>
                        <li class="a-li"><a href="https://www.laravist.com/" class="a-link">Laravist个人网站</a></li>
                        <li class="a-li"><a href="https://www.laracasts.com/" class="a-link">Laracasts个人网站</a></li>
                    </ul>
                </div>
                <div class="col-sm-4">
                    <h3 style="text-align: center">实用推荐</h3>
                    <ul class="a-ul">
                        <li class="a-li"><a href="http://fontawesome.io/" class="a-link">Font Awesome</a></li>
                        <li class="a-li"><a href="http://element.eleme.io/#/zh-CN" class="a-link">Element UI</a></li>
                        <li class="a-li"><a href="http://hao.shejidaren.com/" class="a-link">设计导航</a></li>
                        <li class="a-li"><a href="http://www.ibootstrap.cn/" class="a-link">BootStrap可视化</a></li>
                    </ul>
                </div>
                <div class="col-sm-4">
                    <h3 style="text-align: center">关于建站</h3>
                    <ul class="a-ul">
                        <li class="a-li"><a href="https://www.aliyun.com/?spm=5176.8157463.765261.1.RDCZEp" class="a-link">阿里云</a></li>
                        <li class="a-li"><a href="https://sendcloud.sohu.com/" class="a-link">SendCloud</a></li>
                        <li class="a-li"><a href="https://www.qiniu.com/" class="a-link">七牛云存储</a></li>
                        <li class="a-li"><a href="https://cn.wordpress.org/" class="a-link">WordPress</a></li>
                        <li class="a-li"><a href="http://www.geetest.com/" class="a-link">GEETEST</a></li>
                    </ul>
                </div>
            </div>
        </div>
