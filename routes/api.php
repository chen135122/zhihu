...
Route::get('/articleType','TestController@articleType');
Route::get('/type','DashboardController@firstType');
Route::get('/type/{id}','DashboardController@Type')->where(['id'=>'[0-9]+']);
Route::get('/file/{id}','DashboardController@file');
Route::post('/news/paginate','DashboardController@newsPaginate');
Route::get('/news/{id}','DashboardController@newsById')->where(['id'=>'[0-9]+']);